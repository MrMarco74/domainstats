...
# GitHub-Mirror (github.com/MrMarco74/domainstats). Mirrort den committeten
...
MIRROR_DIR="${MIRROR_DIR:-$HOME/Documents/github/domainstats}"
LOG_PREFIX="[mirror_to_github]"

# Pfade, die NIE in den Mirror dürfen -- zusätzlich zu allem, was .gitignore
# ohnehin von HEAD fernhält. Defense-in-depth: diese Pfade sollten HEAD gar
# nicht mehr enthalten (siehe .gitignore + Historie-Bereinigung), aber wir
# filtern hier trotzdem nochmal explizit.
EXCLUDE_PATTERNS=(
    ".env"
    "hetzner_key"
    "id_rsa"
